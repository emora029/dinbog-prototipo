    ...
    return Row(
      children: <Widget>[
        RichText(
          text: TextSpan(
          text: description,
          style: TextStyle(fontSize: 12.6, color: Colors.black, fontWeight: FontWeight.bold,),
          children: <TextSpan>[
            TextSpan(text: number,style: TextStyle(fontSize: 12.6, fontWeight: FontWeight.bold, color: Color.fromRGBO(17, 129, 195, 1.0))),
            ]
          ),
        ),
        SizedBox(width: 10,),
